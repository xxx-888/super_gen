/**
 * FirstLastFrameNode - 首尾帧生视频节点
 *
 * 接收 first_frame / last_frame / text 输入，输出 video。
 * 调用 creationService.firstLastFrame()。
 */
...
export const FirstLastFrameNode: React.FC<NodeProps> = ({ id, data, selected }) => {
  const meta = NODE_REGISTRY.firstLastFrame
  const d = data as any
